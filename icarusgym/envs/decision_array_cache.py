...
class DecisionArrayCache(GymEnvBase):
    ...
    @staticmethod
    def build_obs_space(kwargs: Optional[dict] = None) -> Box:
        """Builds observation space.

        :param kwargs: Dictionary of keyword arguments.
        :return: Observation space.
        """
        # print("build_obs_space kwargs", kwargs)
        config = kwargs['kwargs']
        # print("build_obs_space config", config)
        node_max = config.get('node_max', 4)
        content_max = config.get('content_max')
